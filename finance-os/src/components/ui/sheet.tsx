...
// Ported verbatim from personal-home/src/components/ui/sheet.tsx so both apps
// share one drawer (see CLAUDE.md: reuse personal-home's design system rather
// than inventing a second one). Used here for the mobile nav.
